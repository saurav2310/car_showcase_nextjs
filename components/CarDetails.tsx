                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="relative p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5 " >
                                    <button
                                        className="absolute top-2 right-2 right-2 z-10 w-fit p-2 bg-primary-blue-100 rounded-full "
                                        type="button"
                                        onClick={closeModal}
                                    >
                                        <Image src='/close.svg'
                                    ...
                                    <div className="flex flex-col flex-1 gap-3">
                                        ...
                                        <div className="flex gap-3">
                                            <div className="flex-1 relative w-full h-24 bg-primary-blue100 rounded-lg">
